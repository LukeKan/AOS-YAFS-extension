...
def main(stop_time, it):
    ...
    for x in range(0, 8):
        ...
        freescale_cpu["c_available"] = x % 5
        nodes_params[x] = freescale_cpu

    jetson_cpu, jetson_gpu = DeviceBuilder.wired_jetson_full()

    jetson_cpu["c_available"] = 3
    jetson_gpu["c_available"] = 4
    nodes_params[8] = jetson_cpu
    nodes_params[9] = jetson_gpu
